...
public class ConfigManager {
    ...
    public void loadConfig()
    {
        ...
        cooltime = config.getInt("cooltime");
        cooltime_lore = config.getString("cooltime-lore");
    }
    ...
    public String getcooltime_lore()
    {
    	return cooltime_lore;
    }
